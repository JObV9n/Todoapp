  ...
  constructor(props) {
    ...
    this.state = {
      ...
      taskList: [{
          "id": 4,
          "title": "task",
          "description": "takes 10 days to finish",
          "dueDate": "2023-08-26T21:27:00Z",
          "completed": false
      }
      ]
    };
  ...
  render() {
    return (
      <main className="content p-3 mb-2 bg-info">
        ...
        {/* footer */}
        {/* <footer className="my-3 mb-2 bg-info text-white text-center">Copyright to &copy; All rights reserved</footer> */}
        {this.state.modal ? (
          <Modal
